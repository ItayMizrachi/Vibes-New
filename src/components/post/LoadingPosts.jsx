...
const LoadingPosts = () => {
  return (
    <>
      <div
        role="status"
        class="w-full mt-10 p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
      >
        ...
        <div class="flex items-center justify-center h-[700px] mb-4 bg-gray-300 rounded dark:bg-gray-700">
          <svg
