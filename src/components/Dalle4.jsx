  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center flex-1 max-w-md px-4 py-8 mx-auto bg-white shadow-xl rounded-xl">
        ...
        <button
          onClick={getImages}
          className="w-full py-3 mb-6 font-semibold text-white bg-indigo-500 rounded-lg transition duration-300 hover:bg-indigo-600 focus:ring-2 focus:ring-indigo-400 focus:outline-none"
          type="submit"
          disabled={loading} // Button will be disabled while loading
        >
